            ...
            <div class="card my_card">
                ...
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col-xl-12">
                            <form method="POST" action="{{ route('product.store') }}" id="product_create"
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-4">
                                                ...
                                                <select name="sub_category_id" class="form-control" aria-label="Default select example" id="sub_category" disabled>
                                                    <option value="{{ old('sub_category_id')  }}" selected disabled>Sub Category ရွေးပါ</option>
                                                </select>
                                        ...
                                        <div class="col">
                                            <div class="mb-4 form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    name="is_new_arrival" value="1" {{ old('is_new_arrival') ? 'checked' : '' }} id="newArrival">
                                ...
                                <div class="row" id="single-product">
                                    <div class="col-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" class="form-control" value="{{ old('stock') }}" name="stock" autocomplete="off">
                                              @error('stock')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" class="form-control" name="price" value="{{ old('price') }}" autocomplete="off">
                                            @error('price')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                     ...
                                     <div class="col-xl-6">
                                        <div class="mb-4">
                                            <label class="form-label">Add Discount Price</label>
                                            <input type="text" class="form-control" name="discount_price" value="{{ old('discount_price') }}" autocomplete="off">
                                        </div>

                                    </div>
                                </div>
                                <div id="variation-container" class="d-none">
                                ...
                                <div class="text-end submit-m-btn">
                                    <button type="button" onclick="submitProduct(this)" class="submit-btn">Product
                                        အသစ်ပြုလုပ်မည်</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            return `<div class="row">
                                        <div class="col-2">
                                            <div class="mb-4">
                                                ...
                                                <select name="variations[${uniqueId}]" id="variation" class="form-select" onchange="fetchTypes(event)">
                                        ...
                                        <div class="col-2">
                                            <div class="mb-4">
                                                ...
                                                <select name="types[${uniqueId}]" id="type" class="form-select">
                                                    <option hidden selected disabled>Select</option>
                                        ...
                                        <div class="col-1">
                                            <div class="mb-4">
                                                ...
                                                <input type="color" name="colors[${uniqueId}][]" class="form-control form-control-color">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="mb-4">
