            ...
            <div class="card my_card">
                ...
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col-xl-9">
                            <form method="POST" action="{{ route('customer.update', $customer->id) }}" id="customer_edit" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                    <div style="width: 100px;">
                                        <img src="{{ $customer->photo }}" id="preview" onclick="clickFile()"
                                            class="border-dotted"
                                            style="width: 150px;border-radius: 10px;border: 1px solid #888">
                                    </div>
        ...
        <div class="col-xl-10 offset-xl-1">
            <div class="card my_card">
                ...
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col-xl-9">
                            <form method="POST" action="{{ route('customer.updatePassword', $customer->id) }}"
                                id="password_edit">
                                @csrf
                                @method('PUT')
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="" class="form-label mb-3">စကားဝှက်အတည်ပြုခြင်း / Confirm
                                        Password</label>
