                            ...
                            <tbody>
                                @foreach ($order['order_item'] as $item)
                                    <tr class="text-center">
                                        <td><img src="{{ $item['product']['image']['path'] }}" class="thumbnail_img"
                                                alt="" srcset=""></td>

                                        <td>
                                            {{ $item['product']['name'] }}
                                            @if ($item['product_variation'])
                                                ({{ $item['product_variation']['variation']['name'] }} :
                                                {{ $item['product_variation']['type']['name'] }}
                                                @if ($item['option_variation'])
                                                    , {{ $item['option_variation']['name'] }})
                                                @else
                                                )
                                                @endif
                                            @endif
                                ...
                                <tr class="border-top border-top-dashed text-center">
                                    ...
                                    <td colspan="1" class="fw-bold">
                                        {{ number_format($order['sub_total'] + $order['discount_amount']) }} MMK</td>
                                </tr>
                                @if ($order['discount_amount'])
                                    <tr class="border-top border-top-dashed text-center">
                                        <td colspan="3"></td>
                                        <td colspan="1" class="fw-bold">Discount :</td>

                                        <td colspan="1" class="fw-bold">- {{ number_format($order['discount_amount']) }}
                                            MMK
                                        </td>
                                    </tr>
                                @endif
