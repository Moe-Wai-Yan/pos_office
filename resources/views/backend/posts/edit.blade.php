            ...
            <div class="card my_card">
                <div class="card-header bg-transparent">
                    <a href="{{ route('post') }}" class="card-title mb-0 d-inline-flex align-items-center create_title">
                        ...
                        <span class="create_sub_title">Post ကိုပြုပြင်မည်</span>
                    </a>
                </div><!-- end card header -->
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col-xl-9">
                            <form method="POST" action="{{ route('post.update', $post->id) }}" id="post_create"
                                            ...
                                            <div class="position-relative w-100 image-parent">
                                                <div class="upload mb-5">
                                                    <div class="preview_img">
                                                        <img src="{{ $image->path }}" width=150 height=150 alt="">
                                                    </div>
                                                    <div class="round">
                                                        <input type="text" name="old[]" class="d-none"
                                                            value="{{ $image->id }}">
                                                ...
                                                <textarea name="contents[]" cols="30" rows="3" class="form-control mb-3"
                                                    placeholder="Enter your image description">{{ $image->description }}</textarea>
                                            </div>
                                        @endforeach
                                    </div>
                                ...
                                <div class="text-end submit-m-btn">
                                    <button type="submit" class="submit-btn">Post ပြင်ဆင်မှုများကိုသိမ်းမည် </button>
                                </div>
                            </form>
                        </div>
                    </div>
