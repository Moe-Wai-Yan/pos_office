        ...
        <div class="card my_card">
            ...
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-9">
                        <form method="POST" action="{{route('subcategory.update', $subCategory->id)}}" id="subcategory_update">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" name="category_id" id="category_id">
                                    @foreach($categories as $categoryItem)
                                        <option value="{{ $categoryItem->id }}" {{ $subCategory->category_id == $categoryItem->id ? 'selected' : '' }}>
                                            {{ $categoryItem->name }}
                                        </option>
                                    @endforeach
                                </select>
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreSubCategoryRequest', '#subcategory_update') !!}
    <script>
