...
@section('content')
    ...
    <div class="card-header d-flex justify-content-between align-items-center bg-transparent">
        <h5 class="mb-0 text-dark">Note - <div class="badge badge-myColor" id="badgeTotalCount">{{ App\Models\Note::count() }}</div></h5>

         @if ( App\Models\Note::count() <=0)
           <a class="primary_button" href="{{route('note.create')}}">
             <div class="d-flex align-items-center">
                <i class=" ri-add-circle-fill mr-2 primary-icon"></i>
                <span class="button_content">Note အသစ်ဖန်တီးမည်</span>
            </div>
