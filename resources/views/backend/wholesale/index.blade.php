...
<div class="card brand my_card">
    <div class="card-header d-flex justify-content-between align-items-center bg-transparent">
            <h5 class="mb-0 text-dark">Wholesale - <div class="badge badge-myColor" id="badgeTotalCount">{{ App\Models\VolumePricing::count() }}</div></h5>
            <a class="primary_button" href="{{route('wholesale.create')}}">
                <div class="d-flex align-items-center">
                    <i class=" ri-add-circle-fill mr-2 primary-icon"></i>
                    <span class="button_content">Volume Price အသစ်ဖန်တီးမည်</span>
                </div>
            </a>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="datatable" style="width:100%;">
                    <thead class="text-center text-muted" style="background: #F3F6F9">
                        <th class="text-center no-sort no-search">Product Name</th>
                        <th class="text-center no-sort">Target Qty</th>
                        <th class="text-center no-sort">Discount Price</th>
