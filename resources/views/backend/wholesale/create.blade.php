            ...
            <div class="card my_card">
                <div class="card-header bg-transparent">
                    <a href="{{ route('wholesale') }}" class="card-title mb-0 d-inline-flex align-items-center create_title">
                        ...
                        <span class="create_sub_title">Volume Price အသစ်ဖန်တီးမည်</span>
                    </a>
                </div><!-- end card header -->
                <div class="card-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col-xl-9">
                            <form method="POST" action="{{ route('wholesale.store') }}" id="wholesale_create">
                                @csrf
                                <div class="row">
                                    <div class="col-4">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-4">
                                        <div class="mb-4">
                                            ...
                                            onchange="fetchVariationOptions(this)">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="number" name="quantity" id="quantity"
                                            placeholder="Enter target quantity" required class="form-control">
                                    </div>
                                    <div class="col-6">
                                        <label for="discount-price" class="form-label">Discount Price</label>
                                        <input type="number" name="discount_price" id="discount-price"
                                            placeholder="Enter Discount Price" required class="form-control">
                                    </div>
                                </div>
                                <div class="text-end submit-m-btn">
                                    <button type="submit" class="submit-btn">Volume Price အသစ်ပြုလုပ်မည်</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreVolumePriceRequest', '#wholesale_create') !!}
        ...
        function fetchVariationOptions(element) {
            ...
            $.ajax({
                ...
                if (variationOptions && variationOptions.length != 0) {
                    ...
                    option = "<option selected hidden disabled>There's no variation option within this product</option>"
